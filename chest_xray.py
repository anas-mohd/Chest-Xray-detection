...
"}")
        ...
        self.label_2.setStyleSheet("color: white;")  # Change text color to white
        self.pushButton.setStyleSheet("color: white;")  # Change text color to white
        self.pushButton_2.setStyleSheet("color: white;")  # Change text color to white


    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "PNEUMONIA Detection Apps"))
        self.label.setToolTip(_translate("MainWindow", "<html><head/><body><p><img src=\":/newPrefix/giphy.gif\"/></p></body></html>"))
